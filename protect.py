...
komid = ko.getProfile().mid
kemid = ke.getProfile().mid
kumid = ku.getProfile().mid
Bots=[mid,kimid,kkmid,kcmid,ksmid,kamid,kbmid,komid,kemid,kumid]
    ...
    try:
		...
		pass
                ...
                try:
                  ...
                  cl.sendText(op.param1, "Jangan Sok Jadi Jagoan Deh Lu Njir.\nAdmin Bukan,Owner Juga Bukan\Kick Ah 😛")
                  random.choice(KAC).kickoutFromGroup(op.param1,[op.param2])
                except:
...
#-----------------------------------------------
         #----------------Fungsi Join Group Start-----------------------#
              ...
              if msg.from_ in creator + owner + admin:
