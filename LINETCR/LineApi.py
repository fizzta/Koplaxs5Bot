...
class LINE:
  ...
  def login(self, mail=None, passwd=None, cert=None, token=None, qr=False, callback=None):
    ...
    self._headers = {
          ...
          'X-Line-Access' : 'Eoaiw7nrdwmZxGSfygz7.LaPQ2EgcvCekTAknQ7bMnW.9cSvP5238SaR7iMn6jbzmOsScKhlwxt7ns5pb3VPXhw=', 
          'User-Agent' : 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.108 Safari/537.3' 
           }
